...
def wallcal ():
    ...
    Arealable = Label(page4, text="Wall Width(pixels)").grid(row=3, columnspan=1, )
    Arealable2 = Label(page4, text=CAL).grid(row=3, column=2, )
    Arealable2 = Label(page4, text="Wall Height(pixels)").grid(row=4, columnspan=1, )
    Arealable3 = Label(page4, text=CAL2).grid(row=4, column=2, )
    Arealable4 = Label(page4, text="Total LEDs For Wall").grid(row=5, columnspan=1, )
    Arealable5 = Label(page4, text=CAL3).grid(row=5, column=2, )
    Arealable6= Label(page4, text="Ports Required").grid(row=6, columnspan=1, )
    Arealable7 = Label(page4, text=CAL5).grid(row=6, column=2, )
...
titallable_pg4 = Label (page4, text="").grid(row=0, column=1)
X1 = Label (page4, text="Wall Width:").grid(row=1, column=1)
X1E = Entry(page4, textvariable=wallW).grid(row=1, column=2)
X2 = Label (page4, text="Wall Height").grid(row=2,column=1 )
X2E = Entry(page4, textvariable=wallH).grid(row=2, column=2)
calbutton_pg4= ttk.Button (page4, text='OK', command=wallcal).grid(row=1, column=4)
Reset_pg4= ttk.Button (page4, text='Reset', command=resetpg4).grid(row=2, column=4)
calbutton_pg4= ttk.Button (page4, text='OK2', ).grid(row=3, column=4)
