...
#select =  Menu(menu)
#menu.add_cascade(label="Panels Slect", menu=select)
#select.add_command(label="Vivid4" ,command=Vivd4)
#select.add_command(label="F4" ,command=PF4)
#select.add_command(label="F3" ,command=PF3)
...
def wallmsg():
    ...
    if  V1 == []:
        ...
        titallable_pg4 = Label(popup, text="Please pick a Panel",font=LL_FONT ).grid(row=0, column=1,pady=20 )
        #Arealable0 = Label(pu, text="Your Video Wall Info!",font=L_FONT).grid(row=0, column=0,padx=50,sticky="w"  )
        Arealable = Label(popup, text="Wall Width(pixels):",font=LL_FONT).grid(row=1, column=0, )
        Arealable2 = Label(popup, text=CAL,font=LL_FONT).grid(row=1, column=2, )
        Arealable2 = Label(popup, text="Wall Height(pixels:)",font=LL_FONT).grid(row=2, column=0, )
        Arealable3 = Label(popup, text=CAL2,font=LL_FONT).grid(row=2, column=2 )
        Arealable4 = Label(popup, text="Total LEDs For Wall:",font=LL_FONT).grid(row=3, column=0, )
        Arealable5 = Label(popup, text=CAL3,font=LL_FONT).grid(row=3, column=2, )
        Arealable6 = Label(popup, text="Ports Required:",font=LL_FONT).grid(row=4, column=0, )
        Arealable7 = Label(popup, text=CAL5,font=LL_FONT).grid(row=4, column=2, )

        #label = ttk.Label(popup, text="test").grid(row=0)
        b1= ttk.Button(popup, text= "Okay", command=leavemini).grid(row=5,column=1 , pady=20)
...
calbutton= ttk.Button (page1, text='OK', command=cal1).grid(row=1, column=3)
Reset_pg1= ttk.Button (page1, text='Reset', command=Reset_pg1).grid(row=2, column=3)
...
Arealable2_pg3 = Label(page3, text=fval,font=helv36 ).grid(row=5, column=1,sticky='w'  )

#rest_button_pg3 = ttk.Button(page3, text='Reset', command=lambda :Arealable.destroy()).grid(row=5, column=3 )
...
P4_check = Radiobutton(page4,text= "P4/F4",font=helv36, variable=VP4, value=1,command=test ).grid(row=2, column=1, padx=50,sticky="w")
...
X1E = Entry(page4, textvariable=wallW).grid(row=2, column=3)
X2 = Label (page4, text="Wall Height",font=helv36).grid(row=3,column=2 )
X2E = Entry(page4, textvariable=wallH).grid(row=3, column=3)
calbutton_pg4= ttk.Button (page4, text='OK', command=wallmsg).grid(row=4, column=3)
#Reset_pg4= ttk.Button (page4, text='Reset', command=resetpg4).grid(row=6, column=4)
#button_pg4= ttk.Button (page4, text='OK2',command=test).grid(row=9, column=4)
#button2_pg4= ttk.Button (page4, text='OK3',command=wallmsg).grid(row=10, column=4)
#Reset_pg4= ttk.Button (page4, text='Slect Panels', command=Panels).grid(row=0, column=4)
